class GameState:
        ...
        for r in range(len(self.board)):
            for c in range(len(self.board[r])):
                ...
                if (turn == 'w' and self.white_to_move) or (turn == 'b' and not self.white_to_move):
                    ...
                    if piece in move_function:
                        move_function[piece](r, c, moves)
        return moves
    ...
    def get_pawn_moves(self, r, c, moves):
        ...
        if self.white_to_move:
            ...
            if c - 1 >= 0 and r - 1 >= 0 and self.board[r - 1][c - 1][0] == 'b':
                if not piece_pinned or pin_direction == (-1, -1):
                    moves.append(Move((r, c), (r - 1, c - 1), self.board))

            if c + 1 <= 7 and r - 1 >= 0 and self.board[r - 1][c + 1][0] == 'b':
                if not piece_pinned or pin_direction == (-1, 1):
                    moves.append(Move((r, c), (r - 1, c + 1), self.board))
        else:
            ...
            if c - 1 >= 0 and r + 1 <= 7 and self.board[r + 1][c - 1][0] == 'w':
                if not piece_pinned or pin_direction == (1, -1):
                    moves.append(Move((r, c), (r + 1, c - 1), self.board))

            if c + 1 <= 7 and r + 1 <= 7 and self.board[r + 1][c + 1][0] == 'w':
                if not piece_pinned or pin_direction == (1, 1):
                    moves.append(Move((r, c), (r + 1, c + 1), self.board))
